...
public class ConjuntoEspalhamentoMelhorComRedimensionamentoImpl <T> implements ConjuntoEspalhamento <T> {

    private List<List<T>> tabela = new ArrayList<List<T>> ();
    private int tamanho = 0;

    public ConjuntoEspalhamentoMelhorComRedimensionamentoImpl() {
        for(int i = 0; i<26; i++){
